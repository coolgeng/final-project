angular.module('nutritionApp').controller('nutritionController', ['$http', '$mdEditDialog', '$q', '$timeout', '$scope', function ($http, $mdEditDialog, $q, $timeout, $scope) {
  ...
  $scope.columns = [{
    ...
    name: 'wechatId',
    numeric: true,
    orderBy: 'wechatId.value'
  }, {
    name: 'assignment_score',
    numeric: true,
    orderBy: 'assignment_score.value',
    unit: 'g'
  }, /* {
    name: 'Carbs',
    numeric: true,
  ...
  $http.get('desserts.json').then(function (desserts) {
    ...
    //   type: 'Ice cream',
    //   wechatId: { value: 237.0 },
    //   assignment_score: { value: 9.0 },
    //   carbs: { value: 37.0 },
    //   final_score: { value: 4.3 },
    //   sodium: { value: 129.0 },
    //   calcium: { value: 8.0 },
    ...
    //   name: 'Eclair',
    //   type: 'Pastry',
    //   wechatId: { value:  262.0 },
    //   assignment_score: { value: 16.0 },
    //   carbs: { value: 24.0 },
    //   final_score: { value:  6.0 },
    //   sodium: { value: 337.0 },
    //   calcium: { value:  6.0 },
    //   percentage: { value: 7.0 }
    // });
